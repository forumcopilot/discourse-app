...
/// Discourse thread field data model based on official API documentation
@MappableClass()
class DiscourseThreadField with DiscourseThreadFieldMappable {
  /// Field ID
  ...
  factory DiscourseThreadField.fromJson(Map<String, dynamic> json) {
