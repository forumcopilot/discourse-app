...
/// Converter for Discourse configuration data to FCConfigResult
class DiscourseConfigConverter {
  /// Convert Discourse config to FCConfigResult
  static FCConfigResult toFCConfigResult(DiscourseConfig discourseConfig, String url) {
    return FCConfigResult(
      // Basic configuration
      jsonSupport: true,
      systemVersion: discourseConfig.versionId,
      version: discourseConfig.versionString,
      hookVersion: '1.0',
      apiLevel: '4',
      ...
      smartBannerInfo: '',
      setForumInfo: true,
      isOpen: !discourseConfig.maintenanceMode,
      guestOkay: true,
