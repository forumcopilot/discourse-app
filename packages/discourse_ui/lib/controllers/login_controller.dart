...
import 'package:discourse_ui/models/site_visit_history.dart';
...
import 'package:discourse_ui/views/dialogs/tfa_input_dialog.dart';
...
import 'package:discourse_ui/utils/passkey_platform_stub.dart'
...
class DiscourseLoginController extends GetxController with ErrorHandlingMixin {
  ...
  Future<Map<String, String>> _authenticateWithPasskey({
    ...
    // The server expects standard base64; normalize base64url when needed.
    return {
